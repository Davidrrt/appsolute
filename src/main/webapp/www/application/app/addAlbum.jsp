                ...
                <section class="wrapper">
                    <div class="row mt">
                        <div class="col-lg-offset-1 col-lg-10">
                            <div class="white-panel pn" style="margin-bottom: 7px;padding-bottom: 405px;">
                                <div class="panel-heading">
                                    <div class="pull-left"><h5><i class="fa fa-tablet"></i>Ajout nouveau application</h5></div>
                                    <br>
                                </div>
                                ...
                                <div class="custom-check goleft mt" style="padding-left: 25px;padding-right: 25px;">
                                    ...
                                    <s:form method="post" action="praddal.html" enctype="multipart/form-data">
                                        <s:textfield cssClass="form-control" cssStyle="margin-bottom:10px;"  label="date" name="init2.dateAlbum"></s:textfield>
                                        <s:hidden name="init2.actu"/>
                                        <s:file cssClass="form-control" cssStyle="margin-bottom:20px;" label="image" name="upload"/>
